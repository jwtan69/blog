        ...
        <div class="blo-top1">
          ...
          <h4>Popular Posts </h4>
            <div class="blog-grids wow fadeInDown"  data-wow-duration=".8s" data-wow-delay=".2s">
              <div class="blog-grid-left">
                <a href="singlepage.html"><img src="<?=base_url('assets/images/t2.jpg')?>" class="img-responsive" alt=""></a>
              </div>
          ...
          <h4>Instagram</h4>
            <ul>
              ...
              <li><a href="<?=base_url($init['langu'])?>"><img src="<?=base_url('assets/images/t1.jpg')?>" class="img-responsive" alt=""></a></li>
